...
class ListsIManager{
    ...
    activate() {
        if(this.parentDOM.querySelector(`.list--box:has(.input--box)`)) this.inputLists()        
        if(this.parentDOM.querySelector(`.list--box:has(.select--box)`)) this.selectLists()
    }
    inputLists(){
